...
export default function Timeline() {
  ...
  return (
    <section id="timeline" aria-labelledby="timeline-heading" className="scroll-mt-20 border-t border-black/10">
            ...
            {items.map((item) => {
              ...
              return (
                <li key={item.id} className="mb-10 ml-6 last:mb-0">
                  <span
                    aria-hidden="true"
                    className="absolute -left-[9px] flex h-4 w-4 items-center justify-center rounded-full bg-black"
                  >
